...
module yusur_ndpp_fdk_sim #(
    ...
    input                                   lightning_mac0_enable                   ,//Set 1'b1
    input                                   lightning_mac0_loopback                 ,//Set 1'b0
    output wire                             lightning_mac0_link_status              ,
    output wire                             lightning_mac0_active_status            ,

    input                                   lightning_mac1_enable                   ,//Set 1'b1
    input                                   lightning_mac1_loopback                 ,//Set 1'b0
    ...
    input  wire [USER_DATA_WIDTH-1 : 0]     user_dma_axi_st_port0_rx_tdata          ,
    input  wire [USER_KEEP_WIDTH-1 : 0]     user_dma_axi_st_port0_rx_tstrb          ,//user_dma_axi_st_port3_rx_tkeep
    ...
    input  wire [USER_DATA_WIDTH-1 : 0]     user_dma_axi_st_port1_rx_tdata          ,
    input  wire [USER_KEEP_WIDTH-1 : 0]     user_dma_axi_st_port1_rx_tstrb          ,//user_dma_axi_st_port3_rx_tkeep
    ...
    input  wire [USER_DATA_WIDTH-1 : 0]     user_dma_axi_st_port2_rx_tdata          ,
    input  wire [USER_KEEP_WIDTH-1 : 0]     user_dma_axi_st_port2_rx_tstrb          ,//user_dma_axi_st_port3_rx_tkeep
    ...
    input  wire [USER_DATA_WIDTH-1 : 0]     user_dma_axi_st_port3_rx_tdata          ,
    input  wire [USER_KEEP_WIDTH-1 : 0]     user_dma_axi_st_port3_rx_tstrb          ,//user_dma_axi_st_port3_rx_tkeep
