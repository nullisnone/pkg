...
//--------------------------------------------------------------------------------
    ...
    begin
        ...
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_read_data(32'h00000000,pcie_bar_rd_data_reg)         ;
        ...
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_write_data(32'h00000004,32'h5a010002,4'hf)           ;
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_read_data(32'h00000004,pcie_bar_rd_data_reg)         ;
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_write_data(32'h00000008,32'h5a010003,4'hf)           ;
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_read_data(32'h00000008,pcie_bar_rd_data_reg)         ;
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_write_data(32'h0000000c,32'h5a010004,4'hf)           ;
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_read_data(32'h0000000c,pcie_bar_rd_data_reg)         ;
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_write_data(32'h00000010,32'h5a010005,4'hf)           ;
        #(1*DELAY_UNIT);
        u_m_axi4_lite_if.m_axi_read_data(32'h00000010,pcie_bar_rd_data_reg)         ;
