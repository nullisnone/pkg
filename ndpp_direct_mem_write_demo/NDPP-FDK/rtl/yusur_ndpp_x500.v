...
module yusur_ndpp_x500 ( 
    ...
    //** SFP IIC
    inout   wire            x500_sfp0_i2c_scl,
    inout   wire            x500_sfp0_i2c_sda,

    inout   wire            x500_sfp1_i2c_scl,
    inout   wire            x500_sfp1_i2c_sda,

    inout   wire            x500_sfp2_i2c_scl,
    inout   wire            x500_sfp2_i2c_sda,

    inout   wire            x500_sfp3_i2c_scl,
    inout   wire            x500_sfp3_i2c_sda,

    //** LED SIGNAL
    output  wire            x500_sfp0_link_led,
    output  wire            x500_sfp0_active_led,
    output  wire            x500_sfp1_link_led,
    output  wire            x500_sfp1_active_led,
    output  wire            x500_sfp2_link_led,
    output  wire            x500_sfp2_active_led,
    output  wire            x500_sfp3_link_led,
    output  wire            x500_sfp3_active_led
);
...
//*****************************************************************
    ...
    assign  sfp0_iic_scl_in     =  x500_sfp0_i2c_scl;
    assign  sfp0_iic_sda_in     =  x500_sfp0_i2c_sda;
    assign  x500_sfp0_i2c_scl   =  sfp0_iic_scl_out ? 1'b0 :1'bz;
    assign  x500_sfp0_i2c_sda   =  sfp0_iic_sda_out ? 1'b0:1'bz;

    assign  sfp1_iic_scl_in     =  x500_sfp1_i2c_scl;
    assign  sfp1_iic_sda_in     =  x500_sfp1_i2c_sda;
    assign  x500_sfp1_i2c_scl   =  sfp1_iic_scl_out ? 1'b0 :1'bz;
    assign  x500_sfp1_i2c_sda   =  sfp1_iic_sda_out ? 1'b0:1'bz;

    assign  sfp2_iic_scl_in     =  x500_sfp2_i2c_scl;
    assign  sfp2_iic_sda_in     =  x500_sfp2_i2c_sda;
    assign  x500_sfp2_i2c_scl   =  sfp2_iic_scl_out ? 1'b0 :1'bz;
    assign  x500_sfp2_i2c_sda   =  sfp2_iic_sda_out ? 1'b0:1'bz;

    assign  sfp3_iic_scl_in     =  x500_sfp3_i2c_scl;
    assign  sfp3_iic_sda_in     =  x500_sfp3_i2c_sda;
    assign  x500_sfp3_i2c_scl   =  sfp3_iic_scl_out ? 1'b0 :1'bz;
    assign  x500_sfp3_i2c_sda   =  sfp3_iic_sda_out ? 1'b0:1'bz;
//*********************** END *************************************
...
//*****************************************************************
    `ifndef SIM_EN
        ...
        //** LED PIN
            .x500_sfp0_link_led             ( x500_sfp0_link_led             ),
            .x500_sfp0_active_led           ( x500_sfp0_active_led           ),
            .x500_sfp1_link_led             ( x500_sfp1_link_led             ),
            .x500_sfp1_active_led           ( x500_sfp1_active_led           ),
            .x500_sfp2_link_led             ( x500_sfp2_link_led             ),
            .x500_sfp2_active_led           ( x500_sfp2_active_led           ),
            .x500_sfp3_link_led             ( x500_sfp3_link_led             ),
            .x500_sfp3_active_led           ( x500_sfp3_active_led           ),
