...
module axis_top #(
	...
	input       [USER_DMA_AXI_WIDTH-1 : 0]  axis_rx_tdata						    ,//[DATA_WIDTH-1 : 0]
	input       [USER_WIDTH-1 : 0]          axis_rx_tuser						    ,//
	input       [USER_DMA_AXI_STRB-1 : 0]   axis_rx_tkeep						    ,//[KEEP_WIDTH-1 : 0]
	input       [USER_DMA_AXI_STRB-1 : 0]   axis_rx_tstrb						    ,//[KEEP_WIDTH-1 : 0]
    input                                   axis_rx_tlast                           ,
    //---
...
//--------------------------------------------------------------------------------
    ...
    axis_rx #(
    //---USER_DMA_RX_CH: USER_DMA_WIDTH_64(default) or USER_DMA_WIDTH_256
    .USER_DMA_AXI_WIDTH                     ( USER_DMA_AXI_WIDTH                    ),//64       256
    .USER_DMA_AXI_STRB                      ( USER_DMA_AXI_STRB                     ),//8        32
    .PACKET_LOSS_FIFO_DEPTH                 ( PACKET_LOSS_FIFO_DEPTH                ),//2048     1024
    .PACKET_LOSS_FULL_THR                   ( PACKET_LOSS_FULL_THR                  ),//1108     780
    //---
	.WORK_MODE 				                (WORK_MODE 	                            ),//0:global, 1:local
    .DATA_WIDTH                             (DATA_WIDTH                             ),//32
    .KEEP_WIDTH                             (KEEP_WIDTH                             ),//4
