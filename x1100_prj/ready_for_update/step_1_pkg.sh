#!/usr/bin/env bash
#this is a tool for firmware repackaging.# #!/bin/sh
...
{
	echo "info :"
	echo "product   / -p :	NDPP, Swift2200N"
	echo "sub board / -s :	NDPP{U50,     X3000,   X1100,   X500,    JFM7V690T}"
	echo "version   / -v :	NDPP{040XXXXX,041XXXXX,042XXXXX,043XXXXX,044XXXXX}"
	echo ""
	echo "Arguments:"
	...
	echo ""
	echo "usage:	$0 -p <product> -s <sub-board> -v <version> -f <firmware-filename>"
	echo ""
	echo "e.g.-1	$0 -p NDPP -s u50   -v 04012345 -f ./yusur_ndpp_u50.bin"
	echo "		---> NDPP-Conflux-u50-04012345.bin"
	echo ""
	echo "e.g.-2	$0 -p NDPP -s x500  -v 04310641 -f ./yusur_ndpp_x500.bin"
	echo "		---> NDPP-Conflux-x500-04310641.bin"
	echo ""
	echo "e.g.-3	$0 -p NDPP -s X1100 -v 04210641 -f ./yusur_ndpp_x1100.bin"
	echo "		---> NDPP-Conflux-x1100-04210641.bin"
	echo ""
	echo "e.g.-4	$0 -p NDPP -s x3000 -v 04110304 -f ./ndpp_fw.bin"
	echo "		---> NDPP-Conflux-x3000-04110304.bin"
	echo ""
}
