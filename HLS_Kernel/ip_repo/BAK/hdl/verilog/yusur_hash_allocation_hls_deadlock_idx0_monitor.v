...
module yusur_hash_allocation_hls_deadlock_idx0_monitor ( // for module yusur_hash_allocation_yusur_hash_allocation_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 yusur_hash_allocation_hls_deadlock_idx1_monitor yusur_hash_allocation_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
