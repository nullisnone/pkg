...
`timescale 1ns/1ps
module yusur_hash_allocation_C_MATRIX_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 8,
    AddressRange = 81,
    AddressWidth = 7,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        yusur_hash_allocation_C_MATRIX_RAM_AUTO_1R1W_memcore yusur_hash_allocation_C_MATRIX_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
