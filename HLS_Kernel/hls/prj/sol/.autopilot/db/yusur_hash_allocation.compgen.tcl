...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yusur_hash_allocation_yusur_hash_allocation_stream_stream_stream_stream_axis_0_A_MATRIX_9_RAM_AUTO_bkb BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { o_axiu_user0_data_TVALID { O 1 bit } o_axiu_user0_data_TREADY { I 1 bit } o_axiu_user0_data_TLAST { O 1 vector } } \
} "
} else {
