set SynModuleInfo {
  ...
  {SRCNAME yusur_hash_allocation_Pipeline_LOOP_CALC_VITIS_LOOP_157_2 MODELNAME yusur_hash_allocation_Pipeline_LOOP_CALC_VITIS_LOOP_157_2 RTLNAME yusur_hash_allocation_yusur_hash_allocation_Pipeline_LOOP_CALC_VITIS_LOOP_157_2
    SUBMODULES {
      ...
      {MODELNAME yusur_hash_allocation_mac_muladd_8ns_8ns_16ns_17_4_1 RTLNAME yusur_hash_allocation_mac_muladd_8ns_8ns_16ns_17_4_1 BINDTYPE op TYPE all IMPL dsp48 LATENCY 3 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME yusur_hash_allocation_Pipeline_LOOP_OUTPUT_BEATS MODELNAME yusur_hash_allocation_Pipeline_LOOP_OUTPUT_BEATS RTLNAME yusur_hash_allocation_yusur_hash_allocation_Pipeline_LOOP_OUTPUT_BEATS
    SUBMODULES {
      {MODELNAME yusur_hash_allocation_mux_1287_24_1_1 RTLNAME yusur_hash_allocation_mux_1287_24_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME yusur_hash_allocation MODELNAME yusur_hash_allocation RTLNAME yusur_hash_allocation IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME yusur_hash_allocation_yusur_hash_allocation_stream_stream_stream_stream_axis_0_C_MATRIX_9_RAM_AUTO_ipb RTLNAME yusur_hash_allocation_yusur_hash_allocation_stream_stream_stream_stream_axis_0_C_MATRIX_9_RAM_AUTO_ipb BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
